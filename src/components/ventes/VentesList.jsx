...
const VentesList = () => {
  ...
  return (
    <div className="space-y-4 lg:space-y-6 p-3 lg:p-6">
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-base-content/60 mt-1">
                      {vente.client_nom || 'Anonyme'} • {formatDate(vente.date_vente)}
                    </p>
                    <div className="mt-2">
                      {vente.est_paye ? (
      ...
      {/* Pagination simplifiée - sans 1/1 */}
            ...
            {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
              ...
              return (
                <button
                  ...
                  className={`btn btn-sm ${currentPage === pageNum ? 'btn-primary text-white' : 'btn-outline'}`}
                >
                  {pageNum}
                </button>
              );
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-mono font-semibold">{selectedVente.reference}</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <p className="font-medium">{selectedVente.client_nom || 'Anonyme'}</p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="text-xs text-base-content/60">Sous-total</p>
                  <p>{formatPrice(selectedVente.sous_total)}</p>
                </div>
                <div>
                  <p className="text-xs text-base-content/60">TVA (18%)</p>
                  <p>{formatPrice(selectedVente.tva)}</p>
                </div>
                <div>
                  <p className="text-xs text-base-content/60 font-bold">Total</p>
                  <p className="text-lg font-bold text-primary">{formatPrice(selectedVente.total)}</p>
                </div>
                <div>
                  <p className="text-xs text-base-content/60">Montant payé</p>
                  <p className="text-success font-semibold">{formatPrice(selectedVente.montant_paye)}</p>
                </div>
                <div>
                  <p className="text-xs text-base-content/60">Reste à payer</p>
                  <p className="text-error font-semibold">{formatPrice(selectedVente.montant_du)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="modal-action">
              <button 
                ...
                onClick={() => {
                  ...
                  navigate(`/ventes/${selectedVente.id}`);
                }}
              >
                <Eye className="w-3 h-3" />
