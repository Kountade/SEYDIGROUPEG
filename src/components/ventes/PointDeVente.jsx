...
import {
  ...
  Warehouse, User, Users, CreditCard, Phone, Mail, Barcode,
  Receipt, Loader, Check
} from 'lucide-react'
...
const PointDeVente = () => {
  ...
  /** Extrait une URL d'image valide (gère string, objet {url}, null) */
  ...
  // ============================================================
  // 4. Chargement des lots pour un produit
  // ============================================================
  ...
  // ============================================================
  // 10. Composant Image produit (sans mutation DOM)
  // ============================================================
                ...
                {paginatedProducts.map((product) => {
                  ...
                  return (
                    <button
                      key={pid}
                      type="button"
                      className={`bg-base-200 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border text-left ${
